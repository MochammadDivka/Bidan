 ...
 <?php if ($_SESSION['user'] == 'patient'): ?>
  ...
  <div class="col-sm-4">
    <select class="form-control" id="agamaS" name="agamaS">
      <option value="" disabled selected>Pilih agama suami anda...</option>
      <option value="Islam" <?php echo ($agamaS == 'Islam') ? 'selected' : ''; ?>>Islam</option>
      <option value="Kristen" <?php echo ($agamaS == 'Kristen') ? 'selected' : ''; ?>>Kristen</option>
      <option value="Katolik" <?php echo ($agamaS == 'Katolik') ? 'selected' : ''; ?>>Katolik</option>
      <option value="Hindu" <?php echo ($agamaS == 'Hindu') ? 'selected' : ''; ?>>Hindu</option>
      <option value="Buddha" <?php echo ($agamaS == 'Buddha') ? 'selected' : ''; ?>>Buddha</option>
      <option value="Konghucu" <?php echo ($agamaS == 'Konghucu') ? 'selected' : ''; ?>>Konghucu</option>
      <option value="Konghucu" <?php echo ($agamaS == 'Lainnya') ? 'selected' : ''; ?>>Lainnya</option>
    </select>
  </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        <select class="form-control" id="pendidikanS" name="pendidikanS">
                                                    <option value="" disabled selected>Pilih Pendidikan Terakhir Suami Anda</option>
                                                    <option value="TidakSekolah" <?php echo ($pendidikanS == 'TidakSekolah') ? 'selected' : ''; ?>>Tidak Sekolah</option>
                                                    <option value="SD" <?php echo ($pendidikanS == 'SD') ? 'selected' : ''; ?>>SD (Sekolah Dasar)</option>
                                                    <option value="SMP" <?php echo ($pendidikanS == 'SMP') ? 'selected' : ''; ?>>SMP (Sekolah Menengah Pertama)</option>
                                                    <option value="SMA/SMK" <?php echo ($pendidikanS == 'SMA/SMK') ? 'selected' : ''; ?>>SMA/SMK (Sekolah Menengah Atas/Sekolah Menengah Kejuruan)</option>
                                                    <option value="Diploma" <?php echo ($pendidikanS == 'Diploma') ? 'selected' : ''; ?>>Diploma</option>
                                                    <option value="Sarjana" <?php echo ($pendidikanS == 'Sarjana') ? 'selected' : ''; ?>>Sarjana (S1)</option>
                                                    <option value="Magister" <?php echo ($pendidikanS == 'Magister') ? 'selected' : ''; ?>>Magister (S2)</option>
                                                    <option value="Doktor" <?php echo ($pendidikanS == 'Doktor') ? 'selected' : ''; ?>>Doktor (S3)</option>
                                                </select>
    </div>
</div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="form-control" id="pendidikan" name="pendidikan">
                                                    ...
                                                    <option value="TidakSekolah" <?php echo ($pendidikan == 'TidakSekolah') ? 'selected' : ''; ?>>Tidak Sekolah</option>
                                                    <option value="SD" <?php echo ($pendidikan == 'SD') ? 'selected' : ''; ?>>SD (Sekolah Dasar)</option>
                                                    <option value="SMP" <?php echo ($pendidikan == 'SMP') ? 'selected' : ''; ?>>SMP (Sekolah Menengah Pertama)</option>
                                                    <option value="SMA/SMK" <?php echo ($pendidikan == 'SMA/SMK') ? 'selected' : ''; ?>>SMA/SMK (Sekolah Menengah Atas/Sekolah Menengah Kejuruan)</option>
                                                    <option value="Diploma" <?php echo ($pendidikan == 'Diploma') ? 'selected' : ''; ?>>Diploma</option>
                                                    <option value="Sarjana" <?php echo ($pendidikan == 'Sarjana') ? 'selected' : ''; ?>>Sarjana (S1)</option>
                                                    <option value="Magister" <?php echo ($pendidikan == 'Magister') ? 'selected' : ''; ?>>Magister (S2)</option>
                                                    <option value="Doktor" <?php echo ($pendidikan == 'Doktor') ? 'selected' : ''; ?>>Doktor (S3)</option>
                                                </select>
                                            </div>
