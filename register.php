                        ...
                        <div class="card-block">
                            ...
                            <form method="POST">
                                <div class="form-group form-primary">
                                     <label for="patientname" class="sub-title" style="margin-bottom: 2px;">Nama Pasien</label>
                                ...
                                <div class="form-group form-primary">
                                    <label for="patientname" class="sub-title" style="margin-bottom: 2px;">No Telp</label>
                                ...
                                <div class="form-group form-primary">
                                    <label for="patientname" class="sub-title" style="margin-bottom: 2px;">Kode PIN</label>
                                ...
                                <div class="form-group form-primary">
                                    <label for="patientname" class="sub-title" style="margin-bottom: 2px;">Golongan Darah</label>
                                ...
                                <div class="form-group form-primary">
                                     <label for="patientname" class="sub-title" style="margin-bottom: 2px;">Jenis Kelamin</label>
                                ...
                                <div class="form-group form-primary">
                                     <label for="patientname" class="sub-title" style="margin-bottom: 2px;">Tanggal Lahir </label>
