...
<?php if ($_SESSION['user'] == 'patient') {
    include_once('sidebarpasien.php');
} ?>
                    ...
                    <div class="page-body">
                        <div class="row">
                            ...
                            ?>
                                ...
                                <div class="row col-lg-12">Selamat Datang di XieMedical<br><br></div>
                                <!-- iki panggone mau  -->
                                <div class="card row col-lg-12">
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="sub-title">
                                                    <h2>Selamat Datang <?php echo $rspatient['patientname']; ?>!!</h2>
                                                </div>
                                                <!-- Nav tabs -->
                                                <ul class="nav nav-tabs md-tabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-toggle="tab" href="#home3" role="tab">Riwayat bergabung</a>
                                                        <div class="slide"></div>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#profile3" role="tab">Pemeriksaan</a>
                                                        <div class="slide"></div>
                                                    </li>
                                                </ul>
                                                <!-- Tab panes -->
                                                ...
                                                <div class="tab-content card-block">
                                                    <div class="tab-pane active" id="home3" role="tabpanel">
                                                        <p class="m-0"><b>Riwayat bergabung :</b>
                                                        <h3>Anda mendaftar sejak <?php echo $rspatient['admissiondate']; ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;
                                                            <?php (isset($rsdoc['doctorname']) ? htmlspecialchars($rsdoc['doctorname']) : 'N/A') ?>
                                                        </td>
                                                        <td>&nbsp;<?php echo $rs['app_reason'] ?></td>
