                    ...
                    <div class="auth-box card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h5 class="text-center txt-primary">Masuk</h5>
                                </div>
                            </div>
                            <form method="POST">
                                <div class="form-group form-primary">
                                    <select name="user" class="form-control" required="">
                                        ...
                                        <option value="doctor">Bidan</option>
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        <div class="forgot-phone text-right f-right">
                                            <a href="forgot_password.php" class="text-right f-w-600"> Lupa Password?</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        <div class="forgot-phone text-left f-left">
                                            <a href="register.php" class="text-left f-w-600">Daftar Untuk Pasien</a>
                                        </div>
                                    </div>
                                </div>
